          ...
          <nav className='fixed top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100'>
               <div className="flex flex-wrap items-center justify-between mx-auto px-4 py-2" >
                    ...
                    <div className="menu hidden md:block md:w-auto" id="navbar">
                         ...
                         {/* <div className="text-3xl text-white font-semibold" >Home</div>
                         <div className="text-3xl text-white font-semibold">About</div>
                         <div className="text-3xl text-white font-semibold">Projects</div>
                         <div className="text-3xl text-white font-semibold">Contact</div> */}
                    </div>
               </div>
